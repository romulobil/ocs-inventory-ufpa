...
--
-- Table structure for table `cpus_cache`
--

CREATE TABLE `cpus_cache` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `id_assets_cache`
--

CREATE TABLE `id_assets_cache` (
  `H_ID` int(11) NOT NULL,
  `TAG` varchar(255) DEFAULT 'NA',
  PRIMARY KEY (`H_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `memories_cache`
--
...
--
-- Table structure for table `monitors_cache`
--

CREATE TABLE `monitors_cache` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `H_ID` int(11) NOT NULL,
  `MANUFACTURER` varchar(255) DEFAULT NULL,
  `DESCRIPTION` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `storages_cache`
--

CREATE TABLE `storages_cache` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `H_ID` int(11) NOT NULL,
  `MANUFACTURER` varchar(255) DEFAULT NULL,
  `MODEL` varchar(255) DEFAULT NULL,
